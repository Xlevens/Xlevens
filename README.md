...
|--------|------------|-----------|
| **Karachi Railway System (Simulation)** | Queueing theory-based simulation with real-time metrics and multiple models | C#, .NET |
| **Hospital Management System** | Web app for managing patients, roles, and appointments | Django, Python, SQL |
| **Mini LMS** | A simple learning management system | Python (OOP) |
